...
const data = [
  { name: 'A', value: 80, color: 'url(#grad1)' }, // Use gradient ID
...
const needle = (value, data, cx, cy, iR, oR, color) => {
  ...
  const ang = 170.0 * (1 - data[0].value / total); // Always use the value of 'A'
        ...
        <PieChart width={400} height={500} >
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ stopColor: '#008F75', stopOpacity: 1 }} />
              <stop offset="100%" style={{ stopColor: '#008F75', stopOpacity: 0.1 }} />
            </linearGradient>
            <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ stopColor: '#EF7D00', stopOpacity: 0.1 }} />
              <stop offset="100%" style={{ stopColor: '#EF7D00', stopOpacity: 1 }} />
            </linearGradient>
          </defs>
          <Pie
            dataKey="value"
